    ...
    <main>
      ...
      <section style={{ padding: "80px 0 60px" }}>
        <div className="container">
          <div className="pill">
            <span className="goldHover">VIP Service</span>
          </div>
          <h1
            style={{
              margin: "18px 0 10px",
          ...
          >
            <span className="goldHover">Hostesses (Female)</span>
          </h1>
          <p style={{ margin: 0, fontSize: 18, lineHeight: 1.7, color: "rgba(255,255,255,.72)", maxWidth: 720 }}>
            Event-facing hospitality professionals for VIP guest management, conferences, and launches. 
            Our verified hostesses deliver exceptional service with grace and professionalism.
          </p>
        </div>
      </section>
            ...
            {[
              {
                ...
                desc: "Professional handling of high-profile guests with attention to detail and discretion.",
              },
              {
                title: "Conference Services",
                desc: "Expert support for business conferences, meetings, and corporate events.",
              },
              {
                title: "Product Launches",
                desc: "Brand-focused hospitality for product unveilings and promotional events.",
              },
              {
                title: "Event Coordination",
                desc: "Seamless management of guest flow, registration, and event logistics.",
              },
            ].map((feature) => (
              <div
                key={feature.title}
        ...
        <div className="container">
          ...
          <div style={{ paddingTop: 32, textAlign: "center" }}>
            ...
            <p style={{ marginTop: 12, color: "rgba(255,255,255,.66)", lineHeight: 1.7 }}>
              Download the AssistPro app to connect with verified female hostesses.
            </p>
