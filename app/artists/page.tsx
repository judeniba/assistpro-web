    ...
    <main>
      ...
      <section style={{ padding: "80px 0 60px" }}>
        <div className="container">
          <div className="pill">
            <span className="goldHover">Creative Talent</span>
          </div>
          <h1
            style={{
              margin: "18px 0 10px",
          ...
          >
            <span className="goldHover">Artists</span>
          </h1>
          <p style={{ margin: 0, fontSize: 18, lineHeight: 1.7, color: "rgba(255,255,255,.72)", maxWidth: 720 }}>
            Verified talent for performances and events—portfolio-based, brand-safe. 
            Our curated artists bring exceptional creativity and professionalism to your events.
          </p>
        </div>
      </section>
      ...
      <section style={{ padding: "20px 0 60px" }}>
        <div className="container">
          ...
          >
            {[
              {
                title: "Portfolio-Based Selection",
                desc: "Review verified portfolios showcasing each artist's work and previous performances.",
              },
              {
                title: "Brand-Safe Talent",
                desc: "All artists are vetted to ensure alignment with your brand values and event standards.",
              },
              {
                title: "Diverse Performance Types",
                desc: "From musicians and performers to visual artists and entertainment specialists.",
              },
              {
                title: "Event-Ready Professionals",
                desc: "Experienced artists who understand event logistics and professional conduct.",
              },
            ].map((feature) => (
              <div
                key={feature.title}
        ...
        <div className="container">
          ...
          <div style={{ paddingTop: 32, textAlign: "center" }}>
            ...
            <p style={{ marginTop: 12, color: "rgba(255,255,255,.66)", lineHeight: 1.7 }}>
              Download the AssistPro app to connect with verified artists.
            </p>
